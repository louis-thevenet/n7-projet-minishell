...
/*
 * Backgrounding added. [PM, 17] Ajout d'une rustine nécessaire : lignes 154 et
 * 298 commentées [ZH, 21] : ajout d'un test signalant l'impossibilité de
 * redirections avec ajout (lignes 232-235)
 */
